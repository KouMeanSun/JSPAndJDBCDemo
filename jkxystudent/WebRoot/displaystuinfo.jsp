	...
	<table border="1" cellspacing="" cellpadding="">
		...
		<%
			for(int i=0;i<list.size();i++){
				...
				String hrefUri = "deleteStudent.jsp?studentid="+bean.getId();
				String updatehrefUri = "modifystuinfo.jsp?studentid="+bean.getId();
				System.out.println("hrefUri"+hrefUri);
				%>
		<tr>
			<td>
			<a href=<%=hrefUri%> >删除</a>
